...
public abstract class BookableItem
{
  ...
  public BookedItem addBookedItem(int aQuantity, SnowShoeTour aSnowShoeTour, Participant aParticipant)
  {
    return new BookedItem(aQuantity, aSnowShoeTour, aParticipant, this);
  }
